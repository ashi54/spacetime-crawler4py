...
stopwords = {
    ...
    'can', 'cannot', "can't", 'cause', 'causes', 'certain', 'certainly', 'co', 'com', 'come',
    'comes', 'contain', 'containing', 'contains', 'could', 'couldnt', 'd', 'date', 'did',
    ...
    'et-al', 'etc', 'even', 'ever', 'every', 'everybody', 'everyone', 'everything',
    ...
    'into', 'invention', 'inward', 'is', "isn't", 'it', 'itd', "it'll", 'its', 'itself',
    "i've", 'j', 'just', 'k', 'keep', 'keeps', 'kept', 'kg', 'km', 'know', 'known',
    'knows', 'l', 'largely', 'last', 'lately', 'later', 'latter', 'latterly', 'least',
    'less', 'lest', 'let', 'lets', 'like', 'liked', 'likely', 'line', 'little', "'ll",
    'look', 'looking', 'looks', 'ltd', 'm', 'made', 'mainly', 'make', 'makes', 'many',
    'may', 'maybe', 'me', 'mean', 'means', 'meantime', 'meanwhile', 'merely', 'mg',
    'might', 'million', 'miss', 'ml', 'more', 'moreover', 'most', 'mostly', 'mr', 'mrs',
    'much', 'mug', 'must', 'my', 'myself', 'n', 'na', 'name', 'namely', 'nay', 'nd',
    ...
    'okay', 'old', 'omitted', 'on', 'once', 'one', 'ones', 'only', 'onto', 'or', 'ord',
    ...
    'similar', 'similarly', 'since', 'six', 'slightly', 'so', 'some', 'somebody',
    ...
    'sufficiently', 'suggest', 'sup', 'sure', 't', 'take', 'taken', 'taking', 'tell',
    'tends', 'th', 'than', 'thank', 'thanks', 'thanx', 'that', "that'll", 'thats',
    ...
    "we've", 'what', 'whatever', "what'll", 'whats', 'when', 'whence', 'whenever',
    ...
    'wish', 'with', 'within', 'without', 'wont', 'words', 'world', 'would', 'wouldnt',
    'www', 'x', 'y', 'yes', 'yet', 'you', 'youd', "you'll", 'your', 'youre', 'yours',
    'yourself', 'yourselves', "you've", 'z', 'zero'
}

# tokenize
def tokenize(text_input: str):
    words = re.findall(r'\b\w{2,}\b', content.lower(), flags=re.ASCII)
    return words
...
if __name__ == '__main__':
    tokens_ = tokenize(sys.argv[1])
    frequencies = compute_word_frequencies(tokens_)